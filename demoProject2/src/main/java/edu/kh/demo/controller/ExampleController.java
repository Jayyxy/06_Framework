...
@Slf4j	// lombok 라이브러리가 제공하는로그 객체 자동생성 어노테이션 
...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// src/main/resources/templates/exampl/ex1.html 로 forward
		return "example/ex1";
	...
	@GetMapping("ex3/{path}")
	public String pathVarivbleTest(@PathVariable("path") int path) {
