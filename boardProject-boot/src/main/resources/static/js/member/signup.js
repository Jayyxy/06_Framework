...
// 필수 입력 항목의 유효성 검사 여부르 체크하기 위한 JS 객체 
// - false : 해당 항목은 유효하지 않은 형식으로 작성돔
...
sendAuthkeyBtn.addEventListener("click", () => {
  ...
  // 인증번호 발급 관련된 메시지 지우기
  authKeyMessage.innerHTML;

  // 중복되지 않은 유효햔 이메일을 입력한 경우가 아니면
   ...
   // 0분 0초인 경우 ("00:00 출력 후")
    ...
    // 매개변수로 전달받은 숫자가 10 미만인 경우(한자리) 앞에 0붙어서 반환 
