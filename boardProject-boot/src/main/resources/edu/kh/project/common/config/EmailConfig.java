...
public class EmailConfig {
	 ...
	 * 4. 최종 수신자 이메일을 받음 
	 * 
	 * 기본 포트 25를 사용하지만, 보안강화 포트는 587 이나 465가 자주 사용됨
	 * 
	 * */

	// @Value : properties에 작성된 내용 중 key가 일치하는 value값을 얻어와 필드에 
	...
	@Bean
	public JavaMailSender javaMailSerder() {
		
		/*
		 * Spring 에서 JavaMailSender 를 구성하는 Bean을 정의하기 위한 메서드. 
		 * 
		 * 
