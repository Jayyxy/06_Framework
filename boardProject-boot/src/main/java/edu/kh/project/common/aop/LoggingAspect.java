...
public class LoggingAspect {
	...
	public void beforeController(JoinPoint jp) {
		...
		// [MainCotroller.mainPage]요청 / ip : 159.30.23.19
	...
	public Object arroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable{
		// Throwable - 예외 처리의 최상위 클래스
		// Throwable 주요 자식을 Exception(예외) - 개발자가 처리할 수 있는 문제 
		...
		@AfterThrowing(pointcut = "@annotation(org.springframework.transaction.annotation.Transactional)" , 
				throwing ="ex") 
		public void transactionRollback(JointPoint jp , Throwable ex){
				log.info("*** 트렌잭션이 롤백됨 {} ***", jp.getSignature().getName());
