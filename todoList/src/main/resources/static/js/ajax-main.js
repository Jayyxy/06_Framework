...
// 상세조회에서 수정 버튼(#updateView) 클릭시 (새로운창 생성)
updateView.addEventListener("click" , () => {

  // 기본 상세 조회 팝업 레이어는 숨기고 
  popupLayer.classList.add("popup-hidden");
  ...
  updateBtn.setAttribute("data-todo-no", popuoTodo.innerText);
...
updateBtn.addEventListener("click", e => {
  ...
  .then(result => {
    ...
    if(result > 0){
      ...
      updateTitle.value = "";
      updateContent.value = "";
      updateBtn.removeAttribute("date-todo")
